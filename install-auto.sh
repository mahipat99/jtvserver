...
wget https://raw.githubusercontent.com/mahipat99/jtvserver/main/auto-start.sh
mkdir .termux/boot
mv auto-start.sh ./.termux/boot/
...
echo "Install termux-boot app and restart phone to start the server"
echo "============================================================="
